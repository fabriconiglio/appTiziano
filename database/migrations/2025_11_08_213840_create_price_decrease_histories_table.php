...
return new class extends Migration
{
    ...
    {
        Schema::create('price_decrease_histories', function (Blueprint $table) {
            $table->id();
            ...
            $table->json('previous_values')->nullable()->comment('Valores anteriores (precio_mayor y precio_menor por producto)');
            $table->json('new_values')->nullable()->comment('Valores nuevos (precio_mayor y precio_menor por producto)');
    ...
    {
        Schema::dropIfExists('price_decrease_histories');
    }
};
