...
@section('title', 'Editar Movimiento - ' . $client->full_name)
        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="mb-0">Editar Movimiento - {{ $client->full_name }}</h5>
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('clients.current-accounts.update', [$client, $currentAccount]) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('observations') is-invalid @enderror" 
                                      ...
                                      name="observations" 
                                      rows="3" 
                                      placeholder="Observaciones adicionales sobre el movimiento...">{{ old('observations', $currentAccount->observations) }}</textarea>
                            @error('observations')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
