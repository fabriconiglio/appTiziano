...
@section('title', 'Editar Cliente No Frecuente')
        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="mb-0">
                        <i class="fas fa-user-edit"></i> Editar Cliente No Frecuente
                    </h5>
                ...
                <div class="card-body">
                    <form action="{{ route('cliente-no-frecuentes.update', $clienteNoFrecuente) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('nombre') is-invalid @enderror" 
                                       ...
                                       value="{{ old('nombre', $clienteNoFrecuente->nombre) }}"
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('telefono') is-invalid @enderror" 
                                       ...
                                       value="{{ old('telefono', $clienteNoFrecuente->telefono) }}"
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="date" class="form-control @error('fecha') is-invalid @enderror" 
                                       id="fecha" name="fecha" 
                                       value="{{ old('fecha', $clienteNoFrecuente->fecha->format('Y-m-d')) }}" 
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('peluquero') is-invalid @enderror" 
                                       ...
                                       value="{{ old('peluquero', $clienteNoFrecuente->peluquero) }}" required
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" step="0.01" min="0" 
                                           ...
                                           id="monto" name="monto" 
                                           value="{{ old('monto', $clienteNoFrecuente->monto) }}" required
                                           placeholder="0.00">
                                </div>
                                @error('monto')
                                    <div class="invalid-feedback">{{ $message }}</div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('servicios') is-invalid @enderror" 
                                       ...
                                       value="{{ old('servicios', $clienteNoFrecuente->servicios) }}"
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <textarea class="form-control @error('observaciones') is-invalid @enderror" 
                                          ...
                                          placeholder="Cualquier observación adicional sobre el servicio o cliente...">{{ old('observaciones', $clienteNoFrecuente->observaciones) }}</textarea>
                                @error('observaciones')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row mb-4">
                            <div class="col-12">
                                <div class="alert alert-info">
                                    ...
                                    <p class="mb-1">
                                        <strong>Registrado por:</strong> {{ $clienteNoFrecuente->user->name }}
                                    </p>
                                    <p class="mb-0">
                                        <strong>Fecha de registro:</strong> {{ $clienteNoFrecuente->created_at->format('d/m/Y H:i') }}
                                    </p>
                                </div>
                            </div>
                        </div>
