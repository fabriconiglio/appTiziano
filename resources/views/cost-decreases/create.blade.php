            ...
            <div class="col-md-10">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <span>Nueva Disminución de Costos</span>
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('cost-decreases.preview') }}" method="POST" id="decreaseForm">
                            @csrf
                            ...
                            <div class="d-flex justify-content-end gap-2">
                                <a href="{{ route('cost-decreases.index') }}" class="btn btn-secondary">Cancelar</a>
