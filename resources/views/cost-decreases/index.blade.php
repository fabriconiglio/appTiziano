            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <span>Historial de Disminuciones de Costos</span>
                        <a href="{{ route('cost-decreases.create') }}" class="btn btn-primary btn-sm">
                    ...
                    <div class="card-body">
                        ...
                        <!-- Filtros -->
                        <form action="{{ route('cost-decreases.index') }}" method="GET" class="mb-4">
                            <div class="row g-3">
                                <div class="col-md-3">
                                ...
                                <div class="col-md-3 d-flex align-items-end">
                                    ...
                                    <a href="{{ route('cost-decreases.index') }}" class="btn btn-outline-secondary">
                        ...
                        @if ($histories->isEmpty())
                            <div class="text-center py-5">
                                <div class="text-muted">
                                    ...
                                    <p>Las disminuciones de costos aparecerán aquí</p>
                                </div>
                            </div>
                        @else
                                    ...
                                    <tbody>
                                        @foreach($histories as $history)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ route('cost-decreases.show', $history) }}" class="btn btn-sm btn-outline-primary">
