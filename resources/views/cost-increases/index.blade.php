            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <span>Historial de Aumentos de Costos</span>
                        <a href="{{ route('cost-increases.create') }}" class="btn btn-primary btn-sm">
                    ...
                    <div class="card-body">
                        ...
                        <!-- Filtros -->
                        <form action="{{ route('cost-increases.index') }}" method="GET" class="mb-4">
                            <div class="row g-3">
                                <div class="col-md-3">
                                ...
                                <div class="col-md-3 d-flex align-items-end">
                                    ...
                                    <a href="{{ route('cost-increases.index') }}" class="btn btn-outline-secondary">
                        ...
                        @if ($histories->isEmpty())
                            <div class="text-center py-5">
                                <div class="text-muted">
                                    ...
                                    <p>Los aumentos de costos aparecerán aquí</p>
                                </div>
                            </div>
                        @else
                                    ...
                                    <tbody>
                                        @foreach($histories as $history)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ route('cost-increases.show', $history) }}" class="btn btn-sm btn-outline-primary">
