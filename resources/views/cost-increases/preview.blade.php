            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <span>Vista Previa del Aumento de Costos</span>
                        <a href="{{ route('cost-increases.create') }}" class="btn btn-secondary btn-sm">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('cost-increases.store') }}" method="POST" id="confirmForm">
                            @csrf
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <small class="text-success">
                                                        (+${{ number_format($newCost - $previousCost, 2) }})
                                                    </small>
                                                </td>
                                            </tr>
                                        @endforeach
                            ...
                            <div class="d-flex justify-content-end gap-2 mt-4">
                                <a href="{{ route('cost-increases.create') }}" class="btn btn-secondary">Cancelar</a>
