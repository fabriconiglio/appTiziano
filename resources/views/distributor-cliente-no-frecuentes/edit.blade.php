                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select @error('forma_pago') is-invalid @enderror" 
                                    ...
                                    @foreach(\App\Models\DistributorClienteNoFrecuente::FORMAS_PAGO as $valor => $etiqueta)
                                        <option value="{{ $valor }}" {{ old('forma_pago', $distributorClienteNoFrecuente->forma_pago) == $valor ? 'selected' : '' }}>
                                            {{ $etiqueta }}
                                        </option>
                                    @endforeach
                                </select>
...
document.addEventListener('DOMContentLoaded', function() {
    let productIndex = {{ count(old('products_purchased', $distributorClienteNoFrecuente->products_purchased ?? [])) }};
