...
@section('title', 'Clientes No Frecuentes - Distribuidora')

@section('content')
<div class="container">
    <!-- Cabecera -->
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1><i class="fas fa-user-clock"></i> Clientes No Frecuentes - Distribuidora</h1>
        <a href="{{ route('distributor-cliente-no-frecuentes.create') }}" class="btn btn-primary">
    ...
    <div class="card mb-4">
        <div class="card-body">
            <form action="{{ route('distributor-cliente-no-frecuentes.index') }}" method="GET" class="row g-3">
                <div class="col-md-4">
                    <input type="text" name="search" class="form-control"
                           placeholder="Buscar por nombre, distribuidor, productos o teléfono..."
                ...
                <div class="col-auto">
                    ...
                    @if(request('search'))
                        <a href="{{ route('distributor-cliente-no-frecuentes.index') }}" class="btn btn-light">
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <div class="btn-group" role="group" aria-label="Acciones">
                                        <a href="{{ route('distributor-cliente-no-frecuentes.show', $cliente) }}" 
                                           class="btn btn-info btn-sm" title="Ver detalles">
                                            <i class="fas fa-eye"></i>
                                        </a>
                                        <a href="{{ route('distributor-cliente-no-frecuentes.edit', $cliente) }}" 
                                           class="btn btn-warning btn-sm" title="Editar">
                                            <i class="fas fa-edit"></i>
                                        </a>
                                        <a href="{{ route('distributor-cliente-no-frecuentes.remito', $cliente) }}" 
                                           class="btn btn-danger btn-sm" title="Generar Remito PDF">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <form action="{{ route('distributor-cliente-no-frecuentes.destroy', $cliente) }}" method="POST" style="display: inline;">
                        @csrf
                        @method('DELETE')
