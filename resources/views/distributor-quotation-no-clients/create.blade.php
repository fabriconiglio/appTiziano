...
@section('title', 'Nuevo Presupuesto - Cliente No Registrado')
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h5 class="mb-0 text-dark">Nuevo Presupuesto - Cliente No Registrado</h5>
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('distributor-quotation-no-clients.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="row">
                                <div class="col-md-12 text-center">
                                    ...
                                    <a href="{{ route('distributor-quotation-no-clients.index') }}" class="btn btn-secondary btn-lg">
