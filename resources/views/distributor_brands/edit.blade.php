...
@section('title', 'Edit Distributor Brand')

@section('content')
    <div class="container mx-auto px-4 py-6">
        <div class="bg-white shadow-sm rounded-lg">
            <div class="p-4 border-b border-gray-200">
                <h2 class="fs-4 fw-bold">Edit Distributor Brand</h2>
            </div>

            <div class="p-4">
                <form action="{{ route('distributor_brands.update', $distributorBrand) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="d-flex justify-content-end">
                        <button type="submit" class="btn btn-primary">Update Distributor Brand</button>
                    </div>
                </form>
            </div>
        </div>
