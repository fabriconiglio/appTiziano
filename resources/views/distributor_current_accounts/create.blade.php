...
@section('title', 'Nuevo Movimiento - ' . $distributorClient->full_name)
        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="mb-0">Nuevo Movimiento - {{ $distributorClient->full_name }}</h5>
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('distributor-clients.current-accounts.store', $distributorClient) }}" method="POST">
                        @csrf
                            ...
                            <div class="mb-3">
                                ...
                                <select name="distributor_technical_record_id" id="distributor_technical_record_id" class="form-select @error('distributor_technical_record_id') is-invalid @enderror">
                                    ...
                                    @foreach($technicalRecords as $record)
                                        <option value="{{ $record->id }}" {{ old('distributor_technical_record_id') == $record->id ? 'selected' : '' }}>
