...
@section('title', 'Nuevo Presupuesto - ' . $distributorClient->full_name)
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h5 class="mb-0 text-dark">Nuevo Presupuesto - {{ $distributorClient->full_name }}</h5>
                        <a href="{{ route('distributor-quotations.create') }}" class="btn btn-secondary btn-sm">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('distributor-clients.quotations.store', $distributorClient) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="row mb-4">
                                <div class="col-md-3">
                                    ...
                                    <input type="text" class="form-control @error('quotation_number') is-invalid @enderror"
                                           ...
                                           value="{{ old('quotation_number', $quotationNumber) }}" required readonly>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="datetime-local" class="form-control @error('quotation_date') is-invalid @enderror"
                                           ...
                                           value="{{ old('quotation_date', now()->format('Y-m-d\TH:i')) }}" required>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="datetime-local" class="form-control @error('valid_until') is-invalid @enderror"
                                           ...
                                           value="{{ old('valid_until', now()->addDays(30)->format('Y-m-d\TH:i')) }}" required>
                                    @error('valid_until')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="col-md-3">
                                    ...
                                    <select class="form-select @error('quotation_type') is-invalid @enderror" 
                                        ...
                                        <option value="al_por_mayor" {{ old('quotation_type') === 'al_por_mayor' ? 'selected' : '' }}>Al Por Mayor</option>
                                        <option value="al_por_menor" {{ old('quotation_type') === 'al_por_menor' ? 'selected' : '' }}>Al Por Menor</option>
                                    </select>
                            ...
                            <div class="row mb-4">
                                <div class="col-md-3">
                                    ...
                                    <div class="input-group">
                                        <input type="number" class="form-control @error('tax_percentage') is-invalid @enderror"
                                               ...
                                               value="{{ old('tax_percentage', 21) }}" min="0" max="100" step="0.01" required>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <select class="form-select @error('payment_terms') is-invalid @enderror" 
                                        ...
                                        <option value="efectivo" {{ old('payment_terms') == 'efectivo' ? 'selected' : '' }}>Efectivo</option>
                                        <option value="tarjeta" {{ old('payment_terms') == 'tarjeta' ? 'selected' : '' }}>Tarjeta</option>
                                        <option value="transferencia" {{ old('payment_terms') == 'transferencia' ? 'selected' : '' }}>Transferencia</option>
                                        <option value="cheque" {{ old('payment_terms') == 'cheque' ? 'selected' : '' }}>Cheque</option>
                                    </select>
                                    @error('payment_terms')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="text" class="form-control @error('delivery_terms') is-invalid @enderror"
                                           ...
                                           value="{{ old('delivery_terms', 'Inmediata') }}" placeholder="Ej: Inmediata, 48hs">
                            ...
                            <div class="summary-section">
                                ...
                                <div class="summary-row">
                                    ...
                                    <span id="total-with-tax-display">$0.00</span>
                                </div>
                                <div class="summary-row">
                            ...
                            <div class="row mb-4 mt-5">
                                <div class="col-md-6">
                                    ...
                                    <textarea class="form-control @error('observations') is-invalid @enderror" id="observations" name="observations" rows="3" placeholder="Observaciones adicionales">{{ old('observations') }}</textarea>
                                    @error('observations')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <textarea class="form-control @error('terms_conditions') is-invalid @enderror" id="terms_conditions" name="terms_conditions" rows="3" placeholder="Términos y condiciones del presupuesto">{{ old('terms_conditions') }}</textarea>
                            ...
                            <div class="row">
                                <div class="col-md-12 text-center">
                                    ...
                                    <a href="{{ route('distributor-quotations.create') }}" class="btn btn-secondary btn-lg">
