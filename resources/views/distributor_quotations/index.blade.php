...
@section('title', 'Presupuestos - Distribuidores')

@section('content')
<div class="container-fluid">
    <!-- Cabecera -->
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1>Presupuestos - Distribuidores</h1>
                    <div>
                <a href="{{ route('distributor-quotations.create') }}" class="btn btn-success">
                    ...
                    <tbody>
                        @forelse($quotations as $quotation)
                            <tr>
                                ...
                                <td>
                                    <div class="fw-bold">{{ $quotation->distributorClient->full_name }}</div>
                                    <small class="text-muted">{{ $quotation->distributorClient->email }}</small>
                                </td>
                                ...
                                <td>
                                    <div class="btn-group" role="group">
                                        <a href="{{ route('distributor-clients.quotations.show', [$quotation->distributorClient, $quotation]) }}" 
                                           class="btn btn-info btn-sm"
                                           title="Ver detalle">
                                            <i class="fas fa-eye"></i>
                                        </a>
                                        @if($quotation->isActive())
                                            <a href="{{ route('distributor-clients.quotations.edit', [$quotation->distributorClient, $quotation]) }}" 
                                               class="btn btn-warning btn-sm"
                                               title="Editar">
                                                <i class="fas fa-edit"></i>
                                            </a>
                                        @endif
                                        <a href="{{ route('distributor-clients.quotations.export-pdf', [$quotation->distributorClient, $quotation]) }}" 
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="alert alert-warning">
                        ...
                        <strong>Cliente:</strong> {{ $quotation->distributorClient->full_name }}<br>
                ...
                <div class="modal-footer">
                    ...
                    <form action="{{ route('distributor-clients.quotations.change-status', [$quotation->distributorClient, $quotation]) }}" 
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <form action="{{ route('distributor-clients.quotations.destroy', [$quotation->distributorClient, $quotation]) }}" 
                          method="POST" style="display: inline;">
                        @csrf
                        @method('DELETE')
