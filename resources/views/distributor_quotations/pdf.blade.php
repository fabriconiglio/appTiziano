    ...
    <div class="quotation-info">
        <div class="info-section">
            ...
            <div class="info-row">
                ...
                <span>{{ $distributorClient->full_name }}</span>
            </div>
            <div class="info-row">
                <span class="info-label">DNI:</span>
                <span>{{ $distributorClient->dni ?? 'No especificado' }}</span>
            </div>
            <div class="info-row">
                <span class="info-label">Teléfono:</span>
                <span>{{ $distributorClient->phone ?? 'No especificado' }}</span>
            </div>
            <div class="info-row">
                <span class="info-label">Email:</span>
                <span>{{ $distributorClient->email ?? 'No especificado' }}</span>
            </div>
            <div class="info-row">
                <span class="info-label">Domicilio:</span>
                <span>{{ $distributorClient->domicilio ?? 'No especificado' }}</span>
            </div>
        </div>
