...
@section('title', 'Registrar Pago - ' . $hairdressingSupplier->name)
        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="mb-0">
                        <i class="fas fa-money-bill-wave"></i> Registrar Pago - {{ $hairdressingSupplier->name }}
                    </h5>
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('hairdressing-suppliers.store-payment', $hairdressingSupplier) }}" method="POST">
                        @csrf
