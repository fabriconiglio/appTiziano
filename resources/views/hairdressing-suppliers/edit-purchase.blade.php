...
@section('title', 'Editar Compra - ' . $hairdressingSupplier->name)
        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="mb-0">
                        <i class="fas fa-edit"></i> Editar Compra - {{ $hairdressingSupplier->name }}
                    </h5>
                    <a href="{{ route('hairdressing-suppliers.show', $hairdressingSupplier) }}" class="btn btn-secondary btn-sm">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="supplier_name" 
                                       value="{{ $hairdressingSupplier->name }}" readonly>
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" step="0.01" class="form-control @error('payment_amount') is-invalid @enderror" 
                                           ...
                                           value="{{ old('payment_amount', $purchase->payment_amount) }}" required>
                                </div>
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <textarea class="form-control @error('notes') is-invalid @enderror" 
                                          ...
                                          placeholder="Observaciones adicionales sobre la compra...">{{ old('notes', $purchase->notes) }}</textarea>
                                @error('notes')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
