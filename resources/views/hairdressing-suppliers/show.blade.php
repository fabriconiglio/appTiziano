    ...
    <div class="row">
        <div class="col-md-8">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    @php
                        $purchases = $hairdressingSupplier->hairdressingSupplierPurchases->map(fn($p) => ['type' => 'purchase', 'date' => $p->purchase_date, 'item' => $p]);
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="d-grid gap-2">
                        ...
                        <a href="{{ route('hairdressing-suppliers.create-payment', $hairdressingSupplier) }}" class="btn btn-success btn-sm">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    paymentDeleteButtons.forEach(function(button) {
        button.addEventListener('click', function() {
            ...
            deletePaymentForm.action = '/hairdressing-suppliers/{{ $hairdressingSupplier->id }}/destroy-payment/' + accountId;
