                    ...
                    <h5 class="card-title mb-0">
                        @switch($category)
                            ...
                            @case('forma_pago_deudor')
                                ...
                                @break
                            @case('facturas_a')
                                <i class="fas fa-file-invoice me-2" style="color: #0d6efd;"></i>Facturas A
                                @break
                            @case('facturas_b')
                                <i class="fas fa-file-invoice me-2" style="color: #198754;"></i>Facturas B
                                @break
                            @default
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                <div class="text-center">
                                    ...
                                    <h3 style="color: {{ $colorFactura }};">${{ number_format($data->sum('total'), 2) }}</h3>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="text-center">
                                    <h6 class="text-muted">Cantidad de Facturas</h6>
                                    <h3 style="color: {{ $colorFactura }};">{{ $data->count() }}</h3>
                                </div>
                            </div>
                        </div>
