...
<div class="container-fluid py-4">
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <div>
                        <button id="refreshChart" class="btn btn-primary btn-sm">
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title mb-0">Desglose Detallado por Hora</h5>
                </div>
                <div class="card-body">
...
<!-- Datos del gráfico pasados desde PHP -->
<script type="application/json" id="chart-data">
{
    "labels": @json(array_column($hourlySales, 'label')),
    "data": @json(array_column($hourlySales, 'total'))
}
</script>

<!-- Variable para controlar auto-refresh -->
<script type="application/json" id="refresh-control">
{
    "isCurrentDate": @json($selectedDate->eq($today))
}
</script>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Auto-refresh cada 5 minutos solo si estamos viendo la fecha actual
    const refreshControl = JSON.parse(document.getElementById('refresh-control').textContent);
    if (refreshControl.isCurrentDate) {
