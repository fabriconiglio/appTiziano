            ...
            <div class="col-md-10">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <span>Nueva Disminución de Precios</span>
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('price-decreases.preview') }}" method="POST" id="decreaseForm">
                            @csrf

                            <div class="row mb-4">
                                <h5>Configuración de la Disminución</h5>
                                <hr>

                                <div class="col-md-6 mb-3">
                                    <label class="form-label">Tipo de Disminución *</label>
                                ...
                                <div class="col-md-6 mb-3">
                                    <label for="decrease_value" class="form-label">Valor de la Disminución *</label>
                                    <div class="input-group">
                                        <span class="input-group-text" id="value_prefix">%</span>
                                        <input type="number" step="0.01" min="0.01" class="form-control @error('decrease_value') is-invalid @enderror" 
                                               id="decrease_value" name="decrease_value" value="{{ old('decrease_value') }}" required>
                                ...
                                <div class="col-md-12 mb-3">
                                    <label class="form-label">Alcance de la Disminución *</label>
                                    <div class="form-check">
                                ...
                                <div class="col-md-12 mb-3">
                                    <label class="form-label">Precios a Afectar *</label>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="price_types[]" id="price_mayor" value="precio_mayor" {{ in_array('precio_mayor', old('price_types', ['precio_mayor', 'precio_menor'])) ? 'checked' : '' }}>
                                        <label class="form-check-label" for="price_mayor">
                                            Precio al Mayor
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="price_types[]" id="price_menor" value="precio_menor" {{ in_array('precio_menor', old('price_types', ['precio_mayor', 'precio_menor'])) ? 'checked' : '' }}>
                                        <label class="form-check-label" for="price_menor">
                                            Precio al Menor
                                        </label>
                                    </div>
                                    @error('price_types')
                            ...
                            <div class="d-flex justify-content-end gap-2">
                                <a href="{{ route('price-decreases.index') }}" class="btn btn-secondary">Cancelar</a>
    ...
    @push('scripts')
        ...
        <script>
            $(document).ready(function() {
                ...
                // Manejar cambio de tipo de disminución
                $('input[name="type"]').on('change', function() {
                    ...
                    if (type === 'porcentual') {
                        ...
                        $('#decrease_value').attr('max', '100');
                    } else {
                        prefix.text('$');
                        hint.text('Ingrese el monto fijo a restar');
                        $('#decrease_value').removeAttr('max');
                    }
                });
                ...
                // Validar que al menos un precio esté seleccionado
                $('#decreaseForm').on('submit', function(e) {
                    const checkedPrices = $('input[name="price_types[]"]:checked').length;
                    if (checkedPrices === 0) {
                        e.preventDefault();
                        alert('Debe seleccionar al menos un tipo de precio (Mayor o Menor)');
                        return false;
                    }
                });
