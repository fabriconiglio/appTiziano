            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <span>Vista Previa de la Disminución de Precios</span>
                        <a href="{{ route('price-decreases.create') }}" class="btn btn-secondary btn-sm">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('price-decreases.store') }}" method="POST" id="confirmForm">
                            @csrf
                                                ...
                                                <td>
                                                    @if(in_array('precio_mayor', $form_data['price_types']))
                                                        <div>
                                                            ...
                                                            <br>
                                                            <strong class="text-danger">${{ number_format($new['precio_mayor'], 2) }}</strong>
                                                            <small class="text-danger">
                                                                (-${{ number_format($previous['precio_mayor'] - $new['precio_mayor'], 2) }})
                                                            </small>
                                                        </div>
                                                    @else
                                                ...
                                                <td>
                                                    @if(in_array('precio_menor', $form_data['price_types']))
                                                        <div>
                                                            ...
                                                            <br>
                                                            <strong class="text-danger">${{ number_format($new['precio_menor'], 2) }}</strong>
                                                            <small class="text-danger">
                                                                (-${{ number_format($previous['precio_menor'] - $new['precio_menor'], 2) }})
                                                            </small>
                                                        </div>
                                                    @else
                            ...
                            <div class="d-flex justify-content-end gap-2 mt-4">
                                <a href="{{ route('price-decreases.create') }}" class="btn btn-secondary">Cancelar</a>
