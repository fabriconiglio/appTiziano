            ...
            <div class="col-md-10">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <span>Nuevo Aumento de Precios</span>
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('price-increases.preview') }}" method="POST" id="increaseForm">
                            @csrf
                            ...
                            <div class="d-flex justify-content-end gap-2">
                                <a href="{{ route('price-increases.index') }}" class="btn btn-secondary">Cancelar</a>
    ...
    @push('scripts')
        ...
        <script>
            $(document).ready(function() {
                ...
                $('#increaseForm').on('submit', function(e) {
