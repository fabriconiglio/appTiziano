            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <span>Historial de Aumentos de Precios</span>
                        <a href="{{ route('price-increases.create') }}" class="btn btn-primary btn-sm">
                            <i class="fas fa-plus me-1"></i> Nuevo Aumento
                        </a>
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <!-- Filtros -->
                        <form action="{{ route('price-increases.index') }}" method="GET" class="mb-4">
                            <div class="row g-3">
                                <div class="col-md-3">
                                    <label for="type" class="form-label">Tipo de Aumento</label>
                                ...
                                <div class="col-md-3 d-flex align-items-end">
                                    ...
                                    <a href="{{ route('price-increases.index') }}" class="btn btn-outline-secondary">
                        ...
                        @if ($histories->isEmpty())
                            <div class="text-center py-5">
                                <div class="text-muted">
                                    ...
                                    <h5>No hay registros de aumentos</h5>
                                    <p>Los aumentos de precios aparecerán aquí</p>
                                </div>
                            </div>
                        @else
                                    ...
                                    <tbody>
                                        @foreach($histories as $history)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ route('price-increases.show', $history) }}" class="btn btn-sm btn-outline-primary">
