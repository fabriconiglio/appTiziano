            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="mb-0">
                        ...
                        Alertas de Stock - Peluquería
                    </h5>
                    <div>
                        <button type="button" class="btn btn-success btn-sm" id="mark-all-read-peluqueria">
                ...
                <div class="card-body">
                                ...
                                <tbody>
                                    @foreach($alerts as $alert)
                                        <tr class="{{ $alert->is_read ? 'table-light' : 'table-warning' }}">
                                            <td>
                                                <strong>{{ $alert->product ? $alert->product->name : 'Producto no encontrado' }}</strong>
                                                @if($alert->product && $alert->product->sku)
                    ...
                    @else
                        <div class="text-center py-4">
                            ...
                            <h5>No hay alertas de stock en Peluquería</h5>
                            <p class="text-muted">Todos los productos de peluquería tienen stock suficiente.</p>
                        </div>
                    @endif
                </div>
            </div>
...
$(document).ready(function() {
    ...
    // Marcar todas como leídas (solo peluquería)
    $('#mark-all-read-peluqueria').click(function() {
        $.ajax({
