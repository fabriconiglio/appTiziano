                        ...
                        <form action="{{ route('supplier-inventories.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-md-3 mb-3">
                                    ...
                                    <input type="number" class="form-control @error('peso_gramos') is-invalid @enderror" id="peso_gramos" name="peso_gramos" value="{{ old('peso_gramos') }}" min="1" placeholder="ej: 500">
                                    @error('peso_gramos')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="col-md-3 mb-3">
                                    ...
                                    <input type="number" class="form-control @error('volumen_cm3') is-invalid @enderror" id="volumen_cm3" name="volumen_cm3" value="{{ old('volumen_cm3') }}" min="1" placeholder="ej: 2000">
                                    @error('volumen_cm3')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
