                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control @error('codigo_barra') is-invalid @enderror" id="codigo_barra" name="codigo_barra" value="{{ old('codigo_barra', $supplierInventory->codigo_barra) }}" placeholder="Escaneá o tipeá el de fábrica" autocomplete="off">
                                        ...
                                        @if($supplierInventory->codigo_barra)
                                            <a class="btn btn-outline-danger" href="{{ route('supplier-inventories.etiqueta', $supplierInventory) }}" target="_blank" title="Imprimir etiqueta">
                                ...
                                <div class="col-md-3 mb-3">
                                    ...
                                    <input type="text" inputmode="decimal" class="form-control @error('peso_gramos') is-invalid @enderror" id="peso_gramos" name="peso_gramos" value="{{ old('peso_gramos', $supplierInventory->peso_gramos) }}" placeholder="ej: 1.000,5">
                                    @error('peso_gramos')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="col-md-3 mb-3">
                                    ...
                                    <input type="text" inputmode="decimal" class="form-control @error('volumen_cm3') is-invalid @enderror" id="volumen_cm3" name="volumen_cm3" value="{{ old('volumen_cm3', $supplierInventory->volumen_cm3) }}" placeholder="ej: 13.462,75">
                                    @error('volumen_cm3')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
