                        ...
                        <form action="{{ route('supplier-inventories.update', $supplierInventory) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-md-3 mb-3">
                                    ...
                                    <input type="text" inputmode="decimal" class="form-control @error('peso_gramos') is-invalid @enderror" id="peso_gramos" name="peso_gramos" value="{{ old('peso_gramos', $supplierInventory->peso_gramos) }}" placeholder="ej: 500,5">
                                    @error('peso_gramos')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="col-md-3 mb-3">
                                    ...
                                    <input type="text" inputmode="decimal" class="form-control @error('volumen_cm3') is-invalid @enderror" id="volumen_cm3" name="volumen_cm3" value="{{ old('volumen_cm3', $supplierInventory->volumen_cm3) }}" placeholder="ej: 2000,5">
                                    @error('volumen_cm3')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
