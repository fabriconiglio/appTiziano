...
<div class="container">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1>Cuenta Corriente - {{ $supplier->full_name }}</h1>
    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-md-6">
                    <p><strong>Nombre:</strong> {{ $supplier->full_name }}</p>
                    <p><strong>CUIT:</strong> {{ $supplier->cuit ?? 'No registrado' }}</p>
                    <p><strong>Email:</strong> {{ $supplier->email ?? 'No registrado' }}</p>
                </div>
                <div class="col-md-6">
                    <p><strong>Teléfono:</strong> {{ $supplier->phone ?? 'No registrado' }}</p>
                    <p><strong>Dirección:</strong> {{ $supplier->address ?? 'No registrada' }}</p>
