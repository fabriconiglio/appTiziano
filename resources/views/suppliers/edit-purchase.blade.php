...
@section('title', 'Editar Compra - ' . $supplier->name)
        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="mb-0">
                        <i class="fas fa-edit"></i> Editar Compra - {{ $supplier->name }}
                    </h5>
                ...
                <div class="card-body">
                    <form action="{{ route('suppliers.update-purchase', ['supplier' => $supplier, 'purchase' => $purchase]) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
