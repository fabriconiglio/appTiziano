                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('cuit') is-invalid @enderror" 
                                       id="cuit" name="cuit" value="{{ old('cuit', $supplier->cuit) }}" 
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select @error('tax_category') is-invalid @enderror" 
                                    ...
                                    <option value="Responsable Inscripto" {{ old('tax_category', $supplier->tax_category) == 'Responsable Inscripto' ? 'selected' : '' }}>Responsable Inscripto</option>
                                    <option value="Monotributista" {{ old('tax_category', $supplier->tax_category) == 'Monotributista' ? 'selected' : '' }}>Monotributista</option>
                                    <option value="Exento" {{ old('tax_category', $supplier->tax_category) == 'Exento' ? 'selected' : '' }}>Exento</option>
                                    <option value="Consumidor Final" {{ old('tax_category', $supplier->tax_category) == 'Consumidor Final' ? 'selected' : '' }}>Consumidor Final</option>
                                </select>
                                @error('tax_category')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <textarea class="form-control @error('notes') is-invalid @enderror" 
                                          ...
                                          placeholder="Información adicional, observaciones, etc.">{{ old('notes', $supplier->notes) }}</textarea>
                                @error('notes')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
