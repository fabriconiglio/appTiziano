        ...
        <div class="col-md-4">
            ...
            <div class="card mb-4">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ route('suppliers.current-account.show', $supplier) }}" class="btn btn-info btn-sm">
                        <i class="fas fa-eye"></i> Ver Historial
                    </a>
                </div>
                <div class="card-body">
                    <div class="text-center mb-3">
                        <h4 class="{{ $supplier->current_balance > 0 ? 'text-danger' : ($supplier->current_balance < 0 ? 'text-success' : 'text-dark') }}">
                    ...
                    <div class="row g-2">
                        <div class="col-6">
                            <div class="text-center">
                                ...
                                <div class="fw-bold {{ $supplier->available_credit > 0 ? 'text-success' : 'text-muted' }}">
                        ...
                        <div class="col-6">
                            <div class="text-center">
                                ...
                                <div class="fw-bold">{{ $supplier->supplierPurchases->count() }}</div>
                            </div>
                        </div>
                    </div>
                </div>
